...
public class ShowTimeController {
    ...
    public ResponseEntity<?> createShowTime(@RequestBody ShowTime showTime) {
        try {
            System.out.println("Received showtime data: " + showTime);
            System.out.println("MovieId: " + showTime.getMovieId());
            System.out.println("ScreenId: " + showTime.getScreenId()); 
            System.out.println("CinemaId: " + showTime.getCinemaId());
            System.out.println("StartTime: " + showTime.getStartTime());
            System.out.println("BasePrice: " + showTime.getBasePrice());
            
            // Validate input
            if (showTime.getMovieId() == null || showTime.getScreenId() == null ||
                showTime.getCinemaId() == null || showTime.getStartTime() == null) {
                return ResponseEntity.badRequest().body("Thiếu thông tin bắt buộc: movieId, screenId, cinemaId, startTime");
            }
